...
var actions = function (_Component) {
	...
	function actions(props, context) {
		...
		var _this = _possibleConstructorReturn(this, (actions.__proto__ || Object.getPrototypeOf(actions)).call(this, props, context));
	...
	_createClass(actions, [{
		...
		value: function handleSubmit(e) {
			e.preventDefault();
			this.props.dispatch((0, _actions.addTodo)(this.state.inputText));
		}
	}, {
		key: 'render',
